        ...
        animateBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (translationState){
                    case 0:
                        imageView.animate().scaleX(2).setDuration(500);
                        break;
                    case 1:
                        imageView.animate().scaleX(1).setDuration(500);
                        break;
                    case 2:
                        imageView.animate().scaleY(0.5f).setDuration(500);
                        break;
                    case 3:
                        imageView.animate().scaleY(1).setDuration(500);
                        break;
                }
